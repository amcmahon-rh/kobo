...
class Task(models.Model):
    ...
    # From Django docs, assigning "+" for related name blocks reverse accessor.
    cancelled_by        = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, related_name="+", on_delete=models.CASCADE)
